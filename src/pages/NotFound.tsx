...
const HomeButton: React.FC<ButtonProps> = ({ children }) => {
  ...
  const buttonClass = `flex justify-center items-center mx-2 my-1 px-4 py-2 text-base font-medium border border-transparent rounded-lg hover:border-indigo-600 cursor-pointer transition-colors duration-200 ${
    theme === "light"
